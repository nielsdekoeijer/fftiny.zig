...
test "fwFFTIterative with 8-point FFT" {
    ...
    fwFFTIterativeComptime(T, 8, inps, @constCast(&outs));
...
pub fn bwFFTIterativeComptime(comptime T: type, comptime n: usize, inp: []const Complex(T), out: *[]Complex(T)) void {
...
test "bwFFTIterative with 8-point FFT" {
    ...
    bwFFTIterativeComptime(T, 8, inps, @constCast(&outs));
